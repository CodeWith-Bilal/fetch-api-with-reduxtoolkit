...
import { searchGitHubRepos, fetchUserRepos, clearRepos, setSearchTerm } from '../features/githubSlice';
      ...
      {repos && repos.length > 0 && (
        <div>
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {repos.map((repo: any) => (
              <div key={repo.id} className="bg-white border rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow">
                <div className="mb-2">
                  <a
                    href={repo.html_url}
                    target="_blank"
